 ...
 * WhatsApp, Facebook…) : assets/og-smartefico-jaune.jpg depuis que le jaune
 * est revenu sur les parties les plus importantes, le 21 septembre 2026. Les
 * deux versions précédentes restent dans le dépôt pour les partages déjà
 * faits : og-smartefico.jpg (noir pur) et og-smartefico-noir.jpg (noir
 * profond, jaune réduit).
 *
...
const FICHIER = 'og-smartefico-jaune.jpg';
