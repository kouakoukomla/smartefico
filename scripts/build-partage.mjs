 ...
 * WhatsApp, Facebook…) : assets/og-smartefico-nb.jpg depuis qu'elle a repris
 * le portrait noir et blanc et perdu son filet, le 23 septembre 2026. Les
 * trois versions précédentes restent dans le dépôt pour les partages déjà
 * faits : og-smartefico.jpg (noir pur), og-smartefico-noir.jpg (noir
 * profond, jaune réduit) et og-smartefico-jaune.jpg (portrait couleur).
 *
...
const FICHIER = 'og-smartefico-nb.jpg';
